                ...
                <table class="table table-bordered table-striped table-sm" id="example1">
					...
					?>
                        <tr>
                            ...
                            <td>
                                <?php if($isi['stok'] <=  '3'){?>
                                <form method="POST" action="function/edit.php?stok=edit">
                                    ...
                                    <a href="function/delete.php?barang=hapus&id=<?php echo $isi['id_barang'];?>"
        ...
        <div id="myModal" class="modal fade" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content" style=" border-radius:0px;">
                    ...
                    <form action="function/tambah.php?barang=tambah" method="POST">
