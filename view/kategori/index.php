...
<?php 
	...
	$edit = $row->fetch();
?>
<form method="POST" action="function/edit.php?kategori=edit">
    <table>
        <tr>
...
<?php }else{?>
<form method="POST" action="function/tambah.php?kategori=tambah">
    <table>
        <tr>
			...
			?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="function/delete.php?kategori=hapus&id=<?php echo $isi['id_kategori'];?>"
